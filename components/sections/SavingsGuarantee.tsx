        ...
        >
          <div
            style={{
              ...
              inset: 0,
              background:
                "radial-gradient(ellipse 60% 90% at 95% 50%, rgba(199,161,74,0.14) 0%, transparent 60%)",
              pointerEvents: "none",
            }}
          />
          <motion.div
          ...
          <div style={{ position: "relative", zIndex: 1 }}>
            ...
            >
              If our AI &amp; Accreditation Readiness Audit doesn&apos;t
              surface a credible roadmap to at least three times its fee in
              annual operating savings, we refund it in full. The risk is ours,
              not your board&apos;s.
            </p>
          </div>
        </motion.div>
