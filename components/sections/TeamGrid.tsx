  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 7, margin: "0 0 4px" }}>
          <h3
            style={{
              fontSize: 17,
              fontWeight: 500,
          ...
          {member.linkedin && (
            <a
              ...
              style={{ display: "inline-flex", alignItems: "center", color: "#4A584E", opacity: 0.5, flexShrink: 0, transition: "opacity 150ms ease" }}
